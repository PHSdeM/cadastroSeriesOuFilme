...
namespace CadastroFilmes.Series
{
    class Program
    {
        ...
        {
            string opcaoSerieouFilmes = ObterSerieOuFilme();

			while (opcaoSerieouFilmes.ToUpper() != "X")
			{
				switch (opcaoSerieouFilmes)
				{
					case "1":
		 ...
		 private static void InserirFilme()
		{
 		...
 		private static string ObterSerieOuFilme()
		{
			Console.WriteLine();
			...
			string opcaoSerieouFilmes = Console.ReadLine().ToUpper();
			Console.WriteLine();
			return opcaoSerieouFilmes;
		}
